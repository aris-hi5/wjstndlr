...
# # 중간 ROI 영역 정의 (ArUco 마커 감지)
# roi_x_medium = 270
# roi_y_medium = 0
# roi_width_medium = 270
# roi_height_medium = 60
# # 작은 영역 ROI 정의 (별 모양 감지)
# roi_x_small = 464
# roi_y_small = 118
# roi_width_small = 35
# roi_height_small = 35
...
#                 print(f"Action executed for marker ID {id} (not moved for 3 seconds)")
#                 del last_seen[id]
#                 break
#     else:
...
#     if star_detected:
#         # Offset the contour points to the small ROI position
